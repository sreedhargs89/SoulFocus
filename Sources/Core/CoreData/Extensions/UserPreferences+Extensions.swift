...
extension UserPreferences {
    ...
    /// True if the user is currently within their 3-day free trial window.
    var isInTrial: Bool {
        guard let start = trialStartDate else { return false }
        let trialDuration: TimeInterval = 3 * 24 * 60 * 60 // 3 days
    ...
    var trialDaysRemaining: Int {
        ...
        let trialDuration: TimeInterval = 3 * 24 * 60 * 60
