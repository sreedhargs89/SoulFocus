...
struct ChantingTabView: View {
    @EnvironmentObject private var container: AppContainer
    @Environment(\.sfTheme) private var theme
    @EnvironmentObject private var manager: SessionManager
    @AppStorage("defaultChantTradition") private var selectedTraditionRaw: String = PrayerTradition.other.rawValue
    ...
    private var beginButton: some View {
        Button {
            ...
            HStack(spacing: 10) {
                ...
                Text("Begin Chanting · \(selectedTradition.displayName)")
